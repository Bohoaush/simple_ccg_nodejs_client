...
(function (AMCP) {
    ...
    class CinfCommand extends AbstractCommand {
        constructor() {
            ...
            this.responseProtocol = new ResponseSignature(201, ResponseValidators_1.Response.ListValidator, ResponseParsers_1.Response.CinfParser); //Changed by Bohoaush from 200 > 201
        }
    }
